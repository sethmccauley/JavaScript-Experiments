...
var waterfallCanvas = function(c, cw, ch){
    ...
    this.Particle.prototype.renderBubble = function(){        
        ...
        _this.ctx.beginPath();
        _this.ctx.arc(this.x+this.width/2, 5+_this.rand(0,10), _this.rand(1,8), 0, Math.PI*2, false);
        _this.ctx.fill();
    };
...
if(isCanvasSupported()){
    ...
    var cw = c.width = window.screen.width;
    var ch = c.height = window.screen.height;  
